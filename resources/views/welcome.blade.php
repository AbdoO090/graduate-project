        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    <!-- ***** Logo Start ***** -->
                    <a href="#" class="logo">
                        <img src="user/assets/images/logo.png" style="width: 130px">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="user/assets/images/feedback.png" alt="online degrees">
            </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="user/assets/images/repair.png" alt="short courses">
            </div>
            <div class="main-content">
              <h4>Short Courses</h4>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            <div class="icon">
              <img src="user/assets/images/electric-car.png" alt="web experts">
            </div>
            <div class="main-content">
              <h4>Web Experts</h4>
      ...
      <div class="row event_box">
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="user/assets/images/img5.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6  development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="user/assets/images/img6.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design wordpress">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="user/assets/images/img2.jpg" alt=""></a>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="user/assets/images/img3.jpg" alt=""></a>
              <span class="category">Development</span>
        ...
        <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
          <div class="events_item">
            <div class="thumb">
              <a href="#"><img src="user/assets/images/img4.jpg" alt=""></a>
              <span class="category">Wordpress</span>
